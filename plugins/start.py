...
async def start(client: Client, message: Message):
        ...
        try:
            invite_link = await client.export_chat_invite_link(Config.FORCE_SUB_CHANNEL)
             ...
             if str(Config.FORCE_SUB_CHANNEL).startswith("-100"):
                 ...
                 invite_link = "https://t.me/Radha_Rani_Backup" # Fallback to updates channel if specific fail
             else:
    ...
    btn = [
        [
            InlineKeyboardButton("📢 Uᴘᴅᴀᴛᴇꜱ", url="https://t.me/Radha_Rani_Backup"),
            InlineKeyboardButton("👨‍💻 Dᴇᴠᴇʟᴏᴘᴇʀ", url="https://t.me/PRESIDENTIND7")
        ],
        [
